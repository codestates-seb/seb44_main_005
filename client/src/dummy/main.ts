export const recommend = {
  recommend: [
    {
      storeId: 1,
      storeName: '언더워터플레이 함덕점',
      body: `제주도 시원한 바닷속에서
        다양한 물고기들을 두 눈으로 보고 체험하는
        특별한 해양 액티비티 언더워터플레이!
        수영을 못하는 초보자들도 쉽게 바닷속을 걸으며
        잊지 못할 새로운 추억을 만들어 가실 수 있습니다.
      `,
    ...
    },
    {
      ...
      storeName: '제주빡빡이 스쿠버',
      body: `안녕하세요!
        제주 빡빡이 스쿠버 비즈클럽 제주다이브 센터 입니다.
        제주바다를 즐길 수 있는 체험다이빙을 제공 하며,
    ...
    },
    {
      storeId: 4,
      storeName: '블루웨일다이브',
      body: `저희 블루웨일다이브는 서귀포에 위치해 있습니다.
        신축건물에 모든장비들이 새장비로 세팅이 되어있습니다.
