    ...
    <div className="flex justify-center items-center h-[100%]">
      <div className="p-10">
        <div className="flex flex-col justify-center w-[700px]">
          <p className="text-2xl font-semibold justify-start border-[1px] border-black p-10">
            파트너 등록하기
          </p>
          <form className="justify-center">
                ...
                <div className="flex space-x-4 justify-end py-2">
                    ...
                    <div className='w-[78%] flex flex-row'>
                        <div className='pr-4 w-[100%]'>
                            ...
                            />
                            <p className='pt-1'>사업자 등록번호는 10자리로 입력되어야 합니다.</p>
                        </div>
                        <button className="rounded-md px-4 h-7 w-28 bg-[#4771B7] text-white">
                            중복확인
                        </button>
                    </div>
                </div>
                ...
                <div className="flex flex-row justify-end py-2">
                    <div className="flex space-x-5 justify-end w-[55%]">
                        ...
                        placeholder="스포츠 및 여가관련 서비스업"
                        />
                    </div>
                    <div className="flex space-x-5 justify-end w-[45%]">
                        <label className="">업종</label>
                        <input
                        className="border-[1px] border-[#9A9A9A] rounded-md w-[75%]  px-2 py-[2px]"
                        placeholder="육상 오락관련 서비스업"
                        />
                    </div>
                </div>
                <div className="flex justify-center pt-4">
                    <button className="font-semibold rounded-md text-xl px-14 py-3 bg-[#4771B7] text-white">
                        등록하기
                    </button>
                </div>
          </form>
